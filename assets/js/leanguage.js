...
function engLeanguage() {
  ...
  footerText.innerHTML =
    '<p>Created with <i class="bi bi-heart-fill text-danger"></i> by <a href="https://github.com/radhiant" class="text-white fw-bold" target="_blank" rel="noopener noreferrer"> Radhian Sobarna</a></p>';
}
...
function idLeanguage() {
  ...
  footerText.innerHTML =
    '<p>Dibuat <i class="bi bi-heart-fill text-danger"></i> oleh <a href="https://github.com/radhiant" class="text-white fw-bold" target="_blank" rel="noopener noreferrer"> Radhian Sobarna</a></p>';
}
